...
\subsection{The studies directly affected on the NFRs of AI}
...
% START :: 여기서부터 작업 시작 -> 모든 논문들에 대한 내용들을 요약(앞에서는 통틀어서 요약)
\subsubsection{The safety of AI}

% 안전성에 대한 설명과 연구 필요성(~~해서 연구가 필요하다.)
% 각 연구들에서 제안하는 방법들에 대한 내용 간단 요약

\subsection{The studies indirectly affected on the NFRs of AI}

% 직접적으로 비기능적 요구사항을 위해서는 아니지만 side-effect로 비기능적 요구사항과 연관지어 생각할 수 있는 연구들에 대해서 가져왔다.
% xai는 인공지능의 투명성과 관련된 연구로 볼 수 있고 adverasarial training은 안전성과 관련된 연구라고 볼 수 있다.
...
% TODO :: \cite{adversarial-yuan} 최근 적대적 예시에 대한 방법론 정리 및 분류

% 논문에서는 분류 모델에 대한 안전성을 주요 주제로 잡았기 때문에 적대적 학습에서 영감을 받아 실험이 진행되었다.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Definition of safety and Experimental design} % TODO :: Overview of experiments에 맞게 내용 전반적으로 수정

% \subsection{Definition of safety in the paper}

...
% TODO :: 자율 주행, 금융 및 의학 ai 관련 참조 논문들 찾기(xai 논문 확인)
In AI, verification of NFRs is important especially in the areas that can have a fatal impact on humans such as autonomous driving\cite{ai-driving-bajarski,ai-driving-levinson}, medical diagnosis\cite{ai-medical-ramsundar,ai-medical-vieira}, and finance\cite{ai-finance-fu}.
...
XAI is the study to enable people to understand the process of training process and deriving results process of AI. % xai 제외 대상
In other words, it can be said that it is a process that can verify the reliability of the results derived by AI.
...
% TODO :: AI의 NFR에 대한 내용들 작성
\subsubsection{About security of AI}
\subsubsection{About reliability(transparency) of AI}
\subsubsection{About safety of AI}

\subsection{Explainable Artificial Intelligence(XAI)} % NOTICE :: 제외 대상
...
Studies in \cite{xai-samek, xai-arrieta} define the concept of XAI and introduce the methodology used for XAI to organize previous studies that have been conducted for XAI.
...
% TODO :: References 정리 완료 후 순서 정렬
% 비기능적 요구사항 속성들 -> AI의 응용분야 -> 

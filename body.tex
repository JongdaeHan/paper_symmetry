...
XAI is the study to enable people to understand the process of training process and deriving results process of AI. % xai 제외 대상 -> transparency 하위 항목으로 이동 reli
...
% \cite{adversarial-yuan} 최근 적대적 예시에 대한 방법론 정리 및 분류

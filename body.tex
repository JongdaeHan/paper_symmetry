...
% START :: 여기서부터 작업 시작
% TODO :: AI의 NFR에 대한 내용들 작성 -> 모든 논문들에 대한 내용들을 요약(앞에서는 통틀어서 요약)
\subsubsection{About security of AI}
\subsubsection{About transparency(transparency) of AI}
\subsubsection{About safety of AI}

\subsection{Explainable Artificial Intelligence(XAI)} % NOTICE :: transparency 하위 항목으로 이동
...
\subsection{Adversarial examples and adversarial attacks} % NOTICE :: safety 하위 항목으로 이동

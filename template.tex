...
Therefore, in this paper, we proceed with a study to verify NFRs of AI, inspired by the other interpretation of previous studies we said above.
...
\begin{enumerate}
    \item	We have shown that adversarial training can lead to improved safety performance. Depending on the experimental results, it can be seen that safety is improved by 2 \~ 40\%.

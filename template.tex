...
% 실험을 통해 적대적 학습이 안전성 성능 개선을 할 수 있음을 확인하였고, 이를 통해 학습 단계 이전 적대적 학습을 위한 적대적 예시를 생성하는 것이 인공지능의 안전성 검증을 위한 방법으로 사용할 수 있음을 확인하였다.
% 또한 서로 다른 비율의 적대적 예시를 포함한 적대적 학습을 통해 중요시 하는 요구사항에 따라 적대적 학습을 진행할 수 있음을 확인하였다. 데이터의 특성에 따른 적대적 예시 포함 비율 조정 또한 요구사항 검증 방법 중 하나로 사용될 수 있음을 주장한다.
...
Existing software has been quickley verifying requirements through V model which makes detailed documentation and testing at each stage of the software development life cycle.
However, with the advent of Deep Neural Network(DNN), artificial intelligence(AI), which has different characteristics with existing software that appeared throughout society, is difficult to verify by methods verifying existing software.
The reason why it is difficult to use the verification methods of existing software in AI is because AI operated as black box model. So, people can't directly know what process it goes through and what features it learns to derive results.
...
However, in AI, funcional requirements can be verified by methods such as measuring the accuracy or F1-score of the model, but NFRs such as safety, security, and transparency are difficult to verify because the operation of code cannot be identified. % TODO :: reference 정리
In AI, it is important to verify not only the functional requirements but also the NFRs of AI in areas that can have a fatal impact on humans such as autonomous driving, medical diagnosis, and finance.
...
That is why AI needs to better verify these NFRs.
Nevertheless, the quality assessment of AI has mainly been made on the functional requirements corresponding to how well the model trained through methods such as accuracy and F1 score rather than on NFRs.\\

% TODO :: Related works 정리 후 수정 예정
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Definition of {\it safety} and Experimental design} % Overview of experiments
...
\begin{specialtable}[H]
    \centering
    \caption{Results of CIFAR-10 with \begin{math}\epsilon\end{math}\label{tab1}}
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
    \cline{1-5} \cline{7-9}
    \multirow{2}{*}{Mixed Ratio} & \multirow{2}{*}{Test set} & \multicolumn{3}{c|}{\begin{math}\epsilon \ 0.05\end{math}}       & \multirow{10}{*}{} & \multicolumn{3}{c|}{\begin{math}\epsilon \ 0.1\end{math}}       \\ \cline{3-5} \cline{7-9} 
                                 &                           & LeNet               & ResNet18              & VGG16              &                    & LeNet              & ResNet18              & VGG16              \\ \cline{1-5} \cline{7-9} 
    \multirow{2}{*}{10:0}        & Clean                     & 63                  & 53                    & 78                 &                    & 63                 & 53                    & 78                 \\ \cline{2-5} \cline{7-9} 
                                 & Adversarial               & 18                  & 33                    & 33                 &                    & 11                 & 27                    & 27                 \\ \cline{1-5} \cline{7-9} 
    \multirow{2}{*}{8:2}         & Clean                     & 60                  & 51                    & 73                 &                    & 60                 & 50                    & 74                 \\ \cline{2-5} \cline{7-9} 
                                 & Adversarial               & 45                  & 35                    & 56                 &                    & 38                 & 31                    & 53                 \\ \cline{1-5} \cline{7-9} 
    \multirow{2}{*}{7:3}         & Clean                     & 58                  & 49                    & 72                 &                    & 57                 & 49                    & 69                 \\ \cline{2-5} \cline{7-9} 
                                 & Adversarial               & 45                  & 36                    & 56                 &                    & 41                 & 34                    & 54                 \\ \cline{1-5} \cline{7-9} 
    \multirow{2}{*}{6:4}         & Clean                     & 58                  & 48                    & 70                 &                    & 58                 & 47                    & 70                 \\ \cline{2-5} \cline{7-9} 
                                 & Adversarial               & 47                  & 36                    & 56                 &                    & 45                 & 34                    & 56                 \\ \cline{1-5} \cline{7-9} 
    \end{tabular}
\end{specialtable}
...
\begin{figure}[H]
    ...
    \caption{Graphs of GTSRB with \begin{math}\epsilon\end{math} 0.05\label{graph1}}
\end{figure} 

\begin{figure}[H]
    \includegraphics[width=13 cm]{Definitions/graph-01gtsrb.png}
    \caption{Graphs of GTSRB with \begin{math}\epsilon\end{math} 0.1\label{graph2}}
\end{figure} 
